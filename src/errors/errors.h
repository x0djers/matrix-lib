...
/**
  ...
  @brief Перечисление всех возможных кодов ошибок, связанных с работой с матрицами.
*/
typedef enum {
...
/**
  ...
  Если язык задан некорректно, то используется язык по умолчанию (обычно `EN_LANGUAGE`).
