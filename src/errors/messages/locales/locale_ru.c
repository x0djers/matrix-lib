...
const MatrixErrorMessage RU_MESSAGES[] = {
	...
	[MATRIX_ALLOCATION_ERROR] = {MATRIX_ALLOCATION_ERROR,
								 "Ошибка выделения памяти для матрицы."},
	...
	[SIZE_MISMATCH_ERROR] = {SIZE_MISMATCH_ERROR,
							 "Ошибка несоотвествия размеров матриц."},
	[NOT_SQUARE_MATRIX_ERROR] = {NOT_SQUARE_MATRIX_ERROR,
	...
	[PREPARE_BUFFER_ERROR] = {PREPARE_BUFFER_ERROR,
							  "Ошибка подготовки строкового представления."},
